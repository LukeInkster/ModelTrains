...
public class Track_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_97q2ds_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_97q2ds_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_97q2ds_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Pos1: Vector");
  ...
  private EditorCell createConstant_97q2ds_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Pos2: Vector");
    editorCell.setCellId("Constant_97q2ds_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
